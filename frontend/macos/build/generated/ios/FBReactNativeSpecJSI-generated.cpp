...
static jsi::Value __hostFunction_NativeAccessibilityManagerCxxSpecJSI_getCurrentHighContrastState(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAccessibilityManagerCxxSpecJSI *>(&turboModule)->getCurrentHighContrastState(
    rt,
    args[0].asObject(rt).asFunction(rt),
    args[1].asObject(rt).asFunction(rt)
  );
...
static jsi::Value __hostFunction_NativeDevSettingsCxxSpecJSI_setIsSecondaryClickToShowDevMenuEnabled(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeDevSettingsCxxSpecJSI *>(&turboModule)->setIsSecondaryClickToShowDevMenuEnabled(
    rt,
    args[0].asBool()
  );
  return jsi::Value::undefined();
...
NativeDevSettingsCxxSpecJSI::NativeDevSettingsCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["setIsSecondaryClickToShowDevMenuEnabled"] = MethodMetadata {1, __hostFunction_NativeDevSettingsCxxSpecJSI_setIsSecondaryClickToShowDevMenuEnabled};
}
