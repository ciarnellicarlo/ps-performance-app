...
struct AlertManagerArgsBridging {
  ...
  static T fromJs(
    ...
    T result{
      ...
      bridging::fromJs<decltype(types.defaultInputs)>(rt, value.getProperty(rt, "defaultInputs"), jsInvoker),
      bridging::fromJs<decltype(types.modal)>(rt, value.getProperty(rt, "modal"), jsInvoker),
      bridging::fromJs<decltype(types.critical)>(rt, value.getProperty(rt, "critical"), jsInvoker)};
    return result;
  }
  ...
  static jsi::Array defaultInputsToJs(jsi::Runtime &rt, decltype(types.defaultInputs) value) {
    return bridging::toJs(rt, value);
  }

  static std::optional<bool> modalToJs(jsi::Runtime &rt, decltype(types.modal) value) {
    return bridging::toJs(rt, value);
  }

  static std::optional<bool> criticalToJs(jsi::Runtime &rt, decltype(types.critical) value) {
    return bridging::toJs(rt, value);
  }
#endif
